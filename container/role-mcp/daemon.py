...
TOOLS_SCHEMA = [
    {
        ...
        "description": (
            ...
            "in the same turn until done (for a job longer than a turn should "
            "hold, park: write yourself a wake file and end the turn — see your "
            "CLAUDE.md). Use mode='sync' ONLY for calls "
